...
const exerciseProgress = [
  { week: "Week 1", target: 100, actual: 45 },
  { week: "Week 2", target: 100, actual: 62 },
  { week: "Week 3", target: 100, actual: 87 },
  { week: "Week 4", target: 100, actual: null },
  { week: "Week 5", target: 100, actual: null },
  { week: "Week 6", target: 100, actual: null },
  { week: "Week 7", target: 100, actual: null },
  { week: "Week 8", target: 100, actual: null },
];
      ...
      <nav className="relative z-10 flex items-center justify-between px-6 py-3 border-b border-white/10 bg-[#050d1a]/90 backdrop-blur-xl flex-shrink-0">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-slate-300 text-sm font-medium">Therapist Workspace</span>
          </div>
        </div>
        ...
        <div className="w-64 flex-shrink-0 border-r border-white/10 bg-[#050d1a]/60 backdrop-blur-xl overflow-y-auto">
          <div className="p-4">
            <div className="flex items-center justify-between mb-3">
              <h2 className="text-xs font-semibold text-slate-400 uppercase tracking-wider">My Patients</h2>
          ...
          <div className="p-4 border-t border-white/10 space-y-3">
            <h3 className="text-xs font-semibold text-slate-400 uppercase tracking-wider">Core Impact</h3>
            {[
              { label: "Therapist capacity", value: "3–5× increase", icon: Users, color: "#00D4AA" },
              { label: "Post-discharge follow-up", value: "<10% → >80%", icon: TrendingUp, color: "#8B5CF6" },
              { label: "Avg. compliance rate", value: "71%", icon: Activity, color: "#F59E0B" },
            ].map((stat) => (
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-5">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-5 gap-3 mt-4">
                {[
                  ...
                  { label: "Avg. session", value: `${selectedPatient.avgSession} min`, color: "#94a3b8" },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            >
              ...
              <ResponsiveContainer width="100%" height={200}>
                <AreaChart data={exerciseProgress}>
                  ...
                  <ReferenceLine y={100} stroke="rgba(255,255,255,0.15)" strokeDasharray="4 4" label={{ value: "Target", position: "right", fill: "#64748b", fontSize: 10 }} />
                  <Area type="monotone" dataKey="actual" name="Actual %" stroke="#00D4AA" fill="url(#actualGrad)" strokeWidth={2} dot={{ fill: "#00D4AA", r: 4 }} connectNulls={false} />
                </AreaChart>
              </ResponsiveContainer>
            </motion.div>
            ...
            <motion.div
              ...
              className="bg-white/5 border border-white/10 rounded-2xl p-5"
            >
              <h3 className="text-sm font-semibold text-white mb-1">Gait Score Trend</h3>
              <p className="text-xs text-slate-400 mb-4">Assessment-by-assessment improvement tracking</p>
              <ResponsiveContainer width="100%" height={200}>
                <BarChart data={gaitScoreTrend} barSize={40}>
                  ...
                  <Legend wrapperStyle={{ fontSize: 11, color: "#94a3b8" }} />
                  <ReferenceLine y={80} stroke="#00D4AA" strokeDasharray="4 4" label={{ value: "Target 80", position: "right", fill: "#00D4AA", fontSize: 10 }} />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <motion.div
              ...
              className="bg-white/5 border border-white/10 rounded-2xl p-5"
            >
              <h3 className="text-sm font-semibold text-white mb-1">Recent Activity Feed</h3>
