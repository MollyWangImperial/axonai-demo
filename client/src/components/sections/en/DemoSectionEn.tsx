/*
 * DemoSectionEn — English product demo section
...
const steps = [
  {
    num: "01",
    title: "Upload Patient Video",
    desc: "Supports standard video from smartphones, tablets, or hospital cameras",
    color: "#00D4AA",
  },
  {
    num: "02",
    title: "AI Automatic Analysis",
    desc: "Computer vision model extracts gait parameters and generates a quantified assessment report",
    color: "#8B5CF6",
  },
  {
    num: "03",
    title: "Receive Rehabilitation Plan",
    desc: "Personalised training programme generated instantly — export as a PDF report",
    color: "#00A8FF",
  },
];

const stats = [
  { value: 3, suffix: " min", label: "Video to Full Report" },
  { value: 17, suffix: "+", label: "Skeletal Landmarks Tracked" },
  { value: 92, suffix: "%", label: "Clinical Assessment Consistency" },
  { value: 40, suffix: "%", label: "Reduction in Therapist Workload" },
];

export default function DemoSectionEn() {
  return (
    <section
      id="demo-en"
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn className="mb-16 text-center">
          ...
          >
            ...
            {" "}from Video to Professional Report
          </h2>
          <p className="text-lg max-w-2xl mx-auto" style={{ color: "oklch(0.6 0.015 250)" }}>
            No specialist training required. Therapists can independently complete a full
            gait assessment and plan generation workflow from the very first session.
          </p>
        </FadeIn>
        ...
        <FadeIn>
          <div
            ...
            style={{
              border: "1px solid oklch(0.22 0.03 240 / 60%)",
