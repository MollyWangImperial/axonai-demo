...
const partners = [
  { name: "北京协和医院康复科", type: "临床合作伙伴", status: "洽谈中" },
  { name: "上海华山医院康复中心", type: "试点验证", status: "洽谈中" },
  { name: "广州中山大学附属医院", type: "数据合作", status: "洽谈中" },
  { name: "北京天坛医院神经康复科", type: "科研合作", status: "洽谈中" },
];
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <FadeIn className="mb-16 text-center">
          <p className="section-label mb-4">团队与信誉</p>
          <h2
          ...
          >
            团队成员来自 Imperial College、Google DeepMind 等顶尖机构，
            将临床医学与前沿 AI 技术深度融合。
          </p>
        </FadeIn>
        ...
        <FadeIn>
          <div className="mb-6">
            <p className="section-label mb-6 text-center">医院合作</p>
          </div>
