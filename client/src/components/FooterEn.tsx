/*
 * FooterEn — English minimal dark footer
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              {["Gait Analysis", "Rehab Plan Generation", "Progress Tracking", "Clinical Reports"].map((item) => (
                <li key={item}>
                  <a
                    ...
                    onMouseLeave={(e) => (e.currentTarget.style.color = "oklch(0.5 0.015 250)")}
                  >
                    {item}
                  </a>
                </li>
        ...
        >
          <p className="text-xs" style={{ color: "oklch(0.38 0.015 250)" }}>
          ...
          <div className="flex items-center gap-6">
            {["Privacy Policy", "Terms of Service", "Cookie Settings"].map((item) => (
              <a
                ...
                onMouseLeave={(e) => (e.currentTarget.style.color = "oklch(0.38 0.015 250)")}
              >
                {item}
              </a>
            ))}
