...
export const initialState = {"reflex___state____state": {"is_hydrated_rx_state_": false, "router_rx_state_": {"session": {"client_token": "", "client_ip": "", "session_id": ""}, "headers": {"host": "", "origin": "", "upgrade": "", "connection": "", "cookie": "", "pragma": "", "cache_control": "", "user_agent": "", "sec_websocket_version": "", "sec_websocket_key": "", "sec_websocket_extensions": "", "accept_encoding": "", "accept_language": "", "raw_headers": {}}, "page": {"host": "", "path": "", "raw_path": "", "full_path": "", "full_raw_path": "", "params": {}}, "url": "", "route_id": ""}}, "reflex___state____state.axonai_vps___axonai_vps____state": {"calib_video_left_name_rx_state_": "", "calib_video_left_path_rx_state_": "", "calib_video_right_name_rx_state_": "", "calib_video_right_path_rx_state_": "", "can_configure_rx_state_": false, "can_generate_report_rx_state_": false, "cols_rx_state_": 6, "configured_rx_state_": false, "n_images_rx_state_": 25, "patient_left_video_name_rx_state_": "", "patient_left_video_path_rx_state_": "", "patient_right_video_name_rx_state_": "", "patient_right_video_path_rx_state_": "", "report_status_rx_state_": "", "rows_rx_state_": 9, "square_size_mm_rx_state_": 25.0, "status_message_rx_state_": ""}, "reflex___state____state.reflex___state____frontend_event_exception_state": {}, "reflex___state____state.reflex___state____on_load_internal_state": {}, "reflex___state____state.reflex___state____update_vars_internal_state": {}}

export const defaultColorMode = "light"
export const ColorModeContext = createContext(null);
export const UploadFilesContext = createContext(null);
export const DispatchContext = createContext(null);
export const StateContexts = {reflex___state____state: createContext(null),reflex___state____state__axonai_vps___axonai_vps____state: createContext(null),reflex___state____state__reflex___state____frontend_event_exception_state: createContext(null),reflex___state____state__reflex___state____on_load_internal_state: createContext(null),reflex___state____state__reflex___state____update_vars_internal_state: createContext(null),};
...
const [reflex___state____state__axonai_vps___axonai_vps____state, dispatch_reflex___state____state__axonai_vps___axonai_vps____state] = useReducer(applyDelta, initialState["reflex___state____state.axonai_vps___axonai_vps____state"])
...
"reflex___state____state.axonai_vps___axonai_vps____state": dispatch_reflex___state____state__axonai_vps___axonai_vps____state,
...
createElement(StateContexts.reflex___state____state__axonai_vps___axonai_vps____state,{value: reflex___state____state__axonai_vps___axonai_vps____state},
